...
const Footer = () => {
  ...
  return (
    <div>
      {/* Two horizontal black lines above footer */}
      <div className="w-full bg-transparent px-4 sm:px-6 lg:px-20">
      ...
      <footer id="contact" className="bg-transparent text-gray-700 pt-16 pb-8 px-4 sm:px-6 lg:px-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 border-b border-gray-300 pb-10">
                ...
                return (
                  <div className="relative group" key={i}>
                    <Link
                      href={href}
                      target="_blank"
                      className="text-gray-600 hover:text-orange-500 transition-transform duration-300 ease-in-out transform group-hover:scale-125"
                    >
                      <Icon size={18} />
                    </Link>
