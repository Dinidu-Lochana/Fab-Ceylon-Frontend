  ...
  return (
    <div>
      ...
      <div className="w-[1500px] h-[200px] relative">
              ...
              {beveragesOpen && (
                ...
                >
                  <div className="flex-col gap-3 h-[100px]">
                    <Link href="/fabceylon-kurunegala/order/delivery/iced-coffee-iced-tea">
                      <div className="text-[#eb650f] text-[14px] font-bold hover:text-white cursor-pointer">
                        Iced Tea & Coffee
                      </div>
                    </Link>
                    <Link href="/fabceylon-kurunegala/order/delivery/hot-beverages">
                      <div className="text-[#eb650f] text-[14px] font-bold hover:text-white cursor-pointer">
                        Hot Beverages
                      </div>
                    </Link>
                    <Link href="/fabceylon-kurunegala/order/delivery/bubble-tea">
                      <div className="text-[#eb650f] text-[14px] font-bold hover:text-white cursor-pointer">
                        Bubble Tea
                      </div>
                    </Link>
                    <Link href="/fabceylon-kurunegala/order/delivery/mojito">
                      <div className="text-[#eb650f] text-[14px] font-bold hover:text-white cursor-pointer">
                        Mojito
                      </div>
                    </Link>
                    <Link href="/fabceylon-kurunegala/order/delivery/milk-shakes">
                      <div className="text-[#eb650f] text-[14px] font-bold hover:text-white cursor-pointer">
                        Milk Shakes
                      </div>
                    </Link>
        ...
        <Link href="/fabceylon-kurunegala/order/delivery/appetizers">
          <div className="menu-item left-[140px]">Appetizers</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/salads-soups">
          <div className="menu-item left-[20px]">Salads & Soups</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/pasta-spaghetti">
          <div className="menu-item left-[260px]">Pasta & Spaghetti</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/noodles">
          <div className="menu-item left-[370px]">Noodles</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/kottu">
          <div className="menu-item left-[470px]">Kottu</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/fried-rice">
          <div className="menu-item left-[580px]">Fried Rice</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/biriyani">
          <div className="menu-item left-[690px]">Biriyani</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/signature-meals">
          <div className="menu-item left-[800px]">Signature Meals</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/burgers">
          <div className="menu-item left-[910px]">Burgers</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/sandwiches-submarines">
          <div className="menu-item left-[1050px]">Sandwiches & Submarines</div>
        </Link>
        <Link href="/fabceylon-kurunegala/order/delivery/desserts">
