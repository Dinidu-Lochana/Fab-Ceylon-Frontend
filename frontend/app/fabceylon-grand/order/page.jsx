...
export default function OrderTypeSelection() {
    return (
        <div>
            <GrandMainMenuNavBar />
            <div className="flex flex-col items-center justify-center min-h-screen text-white bg-[#111010]            ">
                ...
                <div className="flex gap-6">
                    ...
                    <Link href="https://www.ubereats.com/lk/store/fab-ceylon-grand-kandy/WGaHWDj8XaqPFVnFZIUQLg?diningMode=DELIVERY&pl=%3D%3D">
